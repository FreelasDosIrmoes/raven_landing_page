    ...
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <ContactItem
          icon={Globe}
          label="Nosso site"
          value="www.ravensolution.tech/"
          href="https://ravensolution.tech/"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <Button
        variant="outline"
        className="w-full"
        onClick={() => window.open("https://ravensolution.tech/ajuda", "_blank")}
      >
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <Button
        variant="outline"
        className="w-full"
        onClick={() => window.open("https://ravensolution.tech/docs", "_blank")}
      >
